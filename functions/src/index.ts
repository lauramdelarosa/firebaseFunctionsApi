/* //https://us-central1-sepro-d1621.cloudfunctions.net/webApi/api/v1/warmup
...
export const webSEPROApi = functions.https.onRequest(main);
...
app.get('/warmupes', (request, response) => {
   ...
   /*  admin.firestore().doc("figths").get()
        .then(snapshot => {
